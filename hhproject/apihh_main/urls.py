...
urlpatterns = [
    ...
    path('auth/applicant-registration/request/', views.ApplicantRegistrationRequestAPIView.as_view()),
    path('auth/applicant-registration/confirm/', views.ApplicantRegistrationConfirmAPIView.as_view()),
